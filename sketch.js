...
function setup() {
  ...
  invisibleGround = createSprite(200,190,40000000,10);
  invisibleGround.visible = false;
  invisibleGround.position.x=trex.position.x;
  ...
  gameOver=createSprite(100,50,10,10);
  
  restart=createSprite(100,90,10,10);
